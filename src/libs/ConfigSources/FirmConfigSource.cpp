...
extern char _binary_configZ1Pro_default_start;
extern char _binary_configZ1Pro_default_end;
extern char _binary_configZ1_default_start;
extern char _binary_configZ1_default_end;
...
FirmConfigSource::FirmConfigSource(const char* name){
	...
	switch (THEKERNEL->factory_set->MachineModel)
	{
		case CARVERA:
			...
			break;
		case MAKERA_Z1:
			this->start= &_binary_configZ1_default_start;
    		this->end= &_binary_configZ1_default_end;
			break;
		case MAKERA_Z1Pro:
			this->start= &_binary_configZ1Pro_default_start;
    		this->end= &_binary_configZ1Pro_default_end;
			break;
		default:
			this->start= &_binary_config_default_start;
    		this->end= &_binary_config_default_end;
